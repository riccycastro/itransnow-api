...
export const buildTranslationWithTranslationKey = (index: number): Translation => {
...
export const buildTranslationArray = () => [1, 2, 3, 4, 5].map(index => buildTranslation(index));
export const buildTranslationArrayWhitTranslationKey = () => [1, 2, 3, 4, 5].map(index => buildTranslationWithTranslationKey(index));
