...
describe('ApplicationController', () => {
  ...
  describe('getApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.getApplicationAction(req, 'alias'),
      ).rejects.toThrow();
  ...
  describe('getApplicationsAction', () => {
    it('should return a list of application with count', async () => {
      ...
      const findInListSpy = jest
        .spyOn(applicationService, 'findInList')
        .mockImplementation(async () => {
          return expectedResponse;
        });

      expect(await applicationController.getApplicationsAction(req)).toEqual(
        expectedResponse,
      );
  ...
  describe('createApplicationAction', () => {
    it('should throw a conflict exception', async () => {
      ...
      await expect(
        applicationController.createApplicationAction(
          {
            name: 'name',
            alias: 'alias',
          },
    ...
    it('should return undefine and call create and save methods', async () => {
      ...
      expect(
        await applicationController.createApplicationAction(
          {
            name: 'name',
            alias: 'alias',
          },
  ...
  describe('deleteApplicationAction', () => {
    it('should call all necessary methods to delete application', async () => {
      ...
      await expect(
        applicationController.deleteApplicationAction(req, 'alias'),
      ).rejects.toThrow();
      expect(findByAliasOrFailSpy).toHaveBeenCalledTimes(1);
    });
    ...
    it('should save delete operation', async () => {
      ...
      expect(
        await applicationController.deleteApplicationAction(req, 'alias'),
      ).toBe(undefined);
  ...
  describe('updateApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.updateApplicationAction(
          req,
          new ApplicationDto(),
          'alias',
        ),
    ...
    it('should return application if success', async () => {
      ...
      const updateSpy = jest
        .spyOn(applicationService, 'update')
        .mockImplementation(async () => {
          return expectedResult;
        });

      expect(
        await applicationController.updateApplicationAction(
          req,
          new ApplicationDto(),
          'alias',
        ),
  ...
  describe('activeApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.activeApplicationAction(
          req,
          new ActiveApplicationDto(),
          'alias',
        ),
      ).rejects.toThrow();
      expect(findByAliasOrFailSpy).toHaveBeenCalledTimes(1);
    ...
    it('should return activated application', async () => {
      ...
      const activeSpy = jest
        .spyOn(applicationService, 'active')
        .mockImplementation(() => {
          return expectedResult;
        });
      ...
      expect(
        await applicationController.activeApplicationAction(
          req,
          new ActiveApplicationDto(),
          'alias',
        ),
  ...
  describe('addSectionToApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.addSectionToApplicationAction(
          req,
          new SectionDto(),
          'alias',
        ),
    ...
    it('should return created section', async () => {
      ...
      const createSectionSpy = jest
        .spyOn(applicationService, 'createSection')
        .mockImplementation(async () => {
          return section;
        });
      ...
      expect(
        await applicationController.addSectionToApplicationAction(
          req,
          new SectionDto(),
          'alias',
        ),
  ...
  describe('addLanguageToApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.addLanguageToApplicationAction(
          req,
    ...
    it('should return application', async () => {
      ...
      const addLanguagesSpy = jest
        .spyOn(applicationService, 'addLanguages')
        .mockImplementation(async () => {
          return expectedResult;
        });
  ...
  describe('removeLanguageFromApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.removeLanguageFromApplicationAction(
          req,
          new LanguageToApplicationDto(),
          'alias',
        ),
    ...
    it('should return application', async () => {
      ...
      const removeLanguagesSpy = jest
        .spyOn(applicationService, 'removeLanguages')
        .mockImplementation(async () => {
          return expectedResult;
        });
      ...
      expect(
        await applicationController.removeLanguageFromApplicationAction(
          req,
          new LanguageToApplicationDto(),
          'alias',
        ),
  ...
  describe('addTranslationToApplicationAction', () => {
    it('should throw not found exception', async () => {
      ...
      await expect(
        applicationController.addTranslationToApplicationAction(
          req,
          new TranslationDto(),
          'alias',
        ),
    ...
    it('should call createTranslation method', async () => {
      ...
      const createTranslationSpy = jest
        .spyOn(applicationService, 'createTranslation')
        .mockImplementation(async () => {
          return buildTranslation(1);
        });

      expect(
        await applicationController.addTranslationToApplicationAction(
          req,
          new TranslationDto(),
          'alias',
        ),
