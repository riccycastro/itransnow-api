...
export class Version1580246557460 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('CREATE TABLE IF NOT EXISTS `companies` (`id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `alias` VARCHAR(45) NOT NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL, `updated_at` DATETIME NULL, PRIMARY KEY (`id`), UNIQUE INDEX `alias_UNIQUE` (`alias` ASC), UNIQUE INDEX `id_UNIQUE` (`id` ASC))');

    await queryRunner.query('CREATE TABLE IF NOT EXISTS `users` (`id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NOT NULL, `username` VARCHAR(100) NOT NULL, `email` VARCHAR(255) NOT NULL, `password` VARCHAR(255) NOT NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME NULL, `company_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `company_id`), INDEX `fk_users_companies1_idx` (`company_id` ASC), CONSTRAINT `fk_users_companies1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);');

    await queryRunner.query('CREATE TABLE IF NOT EXISTS `applications` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL, `updated_at` DATETIME NULL, `company_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `company_id`), INDEX `fk_applications_companies1_idx` (`company_id` ASC), CONSTRAINT `fk_applications_companies1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);');

    await queryRunner.query('CREATE TABLE IF NOT EXISTS `languages` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `code` VARCHAR(45) NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME NULL, PRIMARY KEY (`id`));');
    ...
    await queryRunner.query('CREATE TABLE IF NOT EXISTS `language_teams` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `alias` VARCHAR(45) NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME NULL, `company_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `company_id`), INDEX `fk_language_teams_companies1_idx` (`company_id` ASC), CONSTRAINT `fk_language_teams_companies1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);');

    await queryRunner.query('CREATE TABLE IF NOT EXISTS `language_team_users` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `is_manager` TINYINT(1) NULL, `language_team_id` BIGINT NOT NULL, `user_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `language_team_id`, `user_id`), INDEX `fk_language_teams_has_users_users1_idx` (`user_id` ASC), INDEX `fk_language_teams_has_users_language_teams1_idx` (`language_team_id` ASC), CONSTRAINT `fk_language_teams_has_users_language_teams1` FOREIGN KEY (`language_team_id`) REFERENCES `language_teams` (`id`) ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT `fk_language_teams_has_users_users1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE);');

    await queryRunner.query('CREATE TABLE IF NOT EXISTS `sections` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `alias` VARCHAR(255) NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME NULL, `application_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `application_id`), INDEX `fk_categories_applications1_idx` (`application_id` ASC), CONSTRAINT `fk_categories_applications1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);');

    await queryRunner.query('CREATE TABLE IF NOT EXISTS `translation_keys` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `alias` VARCHAR(255) NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME NULL, `application_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `application_id`), INDEX `fk_translation_keys_applications1_idx` (`application_id` ASC), CONSTRAINT `fk_translation_keys_applications1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);');
    ...
    await queryRunner.query('CREATE TABLE IF NOT EXISTS `admins` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(100) NULL, `email` VARCHAR(100) NULL, `password` VARCHAR(254) NULL, `is_active` TINYINT(1) DEFAULT 1 NULL, `is_deleted` TINYINT(1) DEFAULT 0 NULL, `created_at` DATETIME NULL, `updated_at` DATETIME NULL, PRIMARY KEY (`id`));');
