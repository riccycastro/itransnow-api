...
export class Version1580246557460 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `users` (`id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NOT NULL, `username` VARCHAR(100) UNIQUE NOT NULL, `email` VARCHAR(255) UNIQUE NOT NULL, `password` VARCHAR(255) NOT NULL, `is_active` TINYINT(1) DEFAULT 1, `is_visible` TINYINT(1) DEFAULT 1, `is_admin` TINYINT(1) DEFAULT 0, `deleted_at_unix` int (10) DEFAULT 0, `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (`id`));',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `applications` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `alias` VARCHAR(45) NOT NULL, `is_active` TINYINT(1) DEFAULT 1, `deleted_at_unix` int (10) DEFAULT 0, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP,  PRIMARY KEY (`id`));',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `languages` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `code` VARCHAR(45) NULL, `is_active` TINYINT(1) DEFAULT 1, `deleted_at_unix` int (10) DEFAULT 0, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (`id`));',
    );
    ...
    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `language_teams` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `alias` VARCHAR(45) NOT NULL, `is_active` TINYINT(1) DEFAULT 1, `deleted_at_unix` int (10) DEFAULT 0, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP, `language_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `language_id`), INDEX `fk_language_teams_languages1_idx` (`language_id` ASC), CONSTRAINT `fk_language_teams_languages1` FOREIGN KEY (`language_id`) REFERENCES `languages` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `language_team_users` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `is_manager` TINYINT(1) DEFAULT 0, `language_team_id` BIGINT NOT NULL, `user_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `language_team_id`, `user_id`), INDEX `fk_language_teams_has_users_users1_idx` (`user_id` ASC), INDEX `fk_language_teams_has_users_language_teams1_idx` (`language_team_id` ASC), CONSTRAINT `fk_language_teams_has_users_language_teams1` FOREIGN KEY (`language_team_id`) REFERENCES `language_teams` (`id`) ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT `fk_language_teams_has_users_users1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE);',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `sections` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `name` VARCHAR(255) NULL, `alias` VARCHAR(255) UNIQUE NOT NULL, `is_active` TINYINT(1) DEFAULT 1, `deleted_at_unix` int (10) DEFAULT 0, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP, `application_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `application_id`), INDEX `fk_categories_applications1_idx` (`application_id` ASC), CONSTRAINT `fk_categories_applications1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `translation_keys` ( `id` BIGINT NOT NULL AUTO_INCREMENT, `alias` VARCHAR(255) UNIQUE NOT NULL, `is_active` TINYINT(1) DEFAULT 1, `deleted_at_unix` int (10) DEFAULT 0, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP, `application_id` BIGINT NOT NULL, PRIMARY KEY (`id`, `application_id`), INDEX `fk_translation_keys_applications1_idx` (`application_id` ASC), CONSTRAINT `fk_translation_keys_applications1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `section_translation_key` (`section_id` BIGINT NOT NULL, `translation_key_id` BIGINT NOT NULL, PRIMARY KEY (`section_id`, `translation_key_id`), INDEX `fk_categories_has_translation_keys_translation_keys1_idx` (`translation_key_id` ASC), INDEX `fk_categories_has_translation_keys_categories1_idx` (`section_id` ASC), CONSTRAINT `fk_categories_has_translation_keys_categories1` FOREIGN KEY (`section_id`) REFERENCES `sections` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT `fk_categories_has_translation_keys_translation_keys1` FOREIGN KEY (`translation_key_id`) REFERENCES `translation_keys` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION);',
    );

    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `translation_status` (`id` BIGINT NOT NULL AUTO_INCREMENT, `status` VARCHAR(45) NULL, PRIMARY KEY (`id`));',
    );
    ...
    await queryRunner.query(
      'CREATE TABLE IF NOT EXISTS `white_label_translations` (`id` BIGINT NOT NULL AUTO_INCREMENT, `white_label_id` BIGINT NOT NULL, `translation_key_id` BIGINT NOT NULL, `translation_id` BIGINT NOT NULL, PRIMARY KEY (`id`,`white_label_id`, `translation_key_id`, `translation_id`), INDEX `fk_white_label_translations_translation_keys1_idx` (`translation_key_id` ASC), INDEX `fk_white_label_translations_translations1_idx` (`translation_id` ASC), CONSTRAINT `fk_white_label_translations_white_labels1` FOREIGN KEY (`white_label_id`) REFERENCES `white_labels` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT `fk_white_label_translations_translation_keys1` FOREIGN KEY (`translation_key_id`) REFERENCES `translation_keys` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT `fk_white_label_translations_translations1` FOREIGN KEY (`translation_id`) REFERENCES `translations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION)',
    );

    await queryRunner.query(
      'ALTER TABLE `users` ADD CONSTRAINT UNIQUE (`email`, `deleted_at_unix`);',
    );
    await queryRunner.query(
      'ALTER TABLE `users` ADD CONSTRAINT UNIQUE (`username`, `deleted_at_unix`);',
    );
    await queryRunner.query(
      'ALTER TABLE `applications` ADD CONSTRAINT UNIQUE (`alias`, `deleted_at_unix`);',
    );
    await queryRunner.query(
      'ALTER TABLE `languages` ADD CONSTRAINT UNIQUE (`code`, `deleted_at_unix`);',
    );
    await queryRunner.query(
      'ALTER TABLE `language_teams` ADD CONSTRAINT UNIQUE (`alias`, `deleted_at_unix`);',
    );
    await queryRunner.query(
      'ALTER TABLE `sections` ADD CONSTRAINT UNIQUE (`alias`, `deleted_at_unix`, `application_id`);',
    );
    await queryRunner.query(
      'ALTER TABLE `translation_keys` ADD CONSTRAINT UNIQUE (`alias`, `deleted_at_unix`, `application_id`);',
    );
    await queryRunner.query(
      'ALTER TABLE `white_labels` ADD CONSTRAINT UNIQUE (`alias`, `deleted_at_unix`, `application_id`);',
    );
  }
