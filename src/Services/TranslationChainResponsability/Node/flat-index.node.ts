        ...
        return translations.reduce((previousData: any, translation: Translation) => {
            if (translation.translationKey.sections) {
                for (const section of translation.translationKey.sections) {
                    previousData[section.alias] = previousData[section.alias] ? previousData[section.alias] : {};
                    previousData[section.alias][translation.translationKey.alias] = translation.translation;
                }
            } else {
