...
export class LanguageTeamUser {
  ...
  @ManyToOne(
    type => LanguageTeam,
    languageTeam => languageTeam.languageTeamUsers,
  )
  @JoinColumn({ name: 'language_team_id' })
  get languageTeam(): LanguageTeam {
    return this._languageTeam;
  }
  set languageTeam(languageTeam: LanguageTeam) {
    this._languageTeam = languageTeam;
  }
}
